...
menu = st.sidebar.radio("", ["App", "HDVI MVR", "All Trans MVR", "Truckings IFTA", "Riscom MVR"])

# Left-aligned heading in main page without border
...
if file1 and file2:
    ...
    # Remove the __name2 column before writing
